...
public class Shooter extends SubsystemBase {
    ...
    public Shooter(int MotorID) {
        ...
        shooterMotor.configure(config, SparkFlex.ResetMode.kResetSafeParameters, SparkFlex.PersistMode.kPersistParameters);
    ...
    public Command prime() {
        ...
        return runEnd(() -> shooterMotor.set(primeSpeed), () -> {}).withName("Prime");
    }
    ...
    public Command shoot() {
        ...
        return runEnd(() -> shooterMotor.set(shootSpeed), () -> {}).withName("Shoot");
    }
